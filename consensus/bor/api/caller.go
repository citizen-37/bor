...
type Caller interface {
	...
	CallWithState(ctx context.Context, state *state.StateDB, args ethapi.TransactionArgs, blockNrOrHash rpc.BlockNumberOrHash, overrides *ethapi.StateOverride) (hexutil.Bytes, error)
}
