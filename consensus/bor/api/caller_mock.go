...
func (m *MockCaller) CallWithState(arg0 context.Context, arg1 *state.StateDB, arg2 ethapi.TransactionArgs, arg3 rpc.BlockNumberOrHash, arg4 *ethapi.StateOverride) (hexutil.Bytes, error) {
	m.ctrl.T.Helper()
